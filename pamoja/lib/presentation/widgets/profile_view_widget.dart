// This widget shows a user's profile in a clean, scrollable view.
// It displays the avatar, name, role, skills, interests, volunteering history, and certificates.
// Everything is view-only here, so no editing is allowed, and it handles both image and PDF certificates gracefully.
...
class ProfileViewWidget extends StatelessWidget {
                    ...
                    return Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: cert.startsWith('data:image')
                            ...
                            : Image.network(cert, fit: BoxFit.cover),
                      ),
                    );
                  },
                ),
  ...
  Future<List<Map<String, dynamic>>> _getVolunteeringHistory(
    String userId,
  ) async {
    try {
