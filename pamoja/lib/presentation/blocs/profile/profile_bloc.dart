// This loads the currently logged-in user's profile from Firestore, converts the data into a
// UserProfile model, and updates the UI state. It handles missing users, missing documents,
// and fetch errors.

// It updates the user's profile in Firestore and refreshes the state. It also includes handlers
// for adding/removing skills and interests, each updating Firestore and syncing changes
// back into the ProfileLoaded state.
  ...
  Future<void> _onLoadProfile(
    ...
    try {
      ...
      final profile = UserProfile(
        ...
        avatarUrl:
            data['avatarUrl'] ?? 'https://i.pravatar.cc/300?u=${user.uid}',
  ...
  Future<void> _onAddInterest(
    ...
    if (state is ProfileLoaded) {
      try {
        ...
        emit(
          ProfileLoaded(currentProfile.copyWith(interests: updatedInterests)),
        );
      } catch (e) {
