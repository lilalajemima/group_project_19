// This file defines the full light and dark themes for the app, including colors,
// text styles, buttons, inputs, and overall UI styling to keep everything consistent.
  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: GoogleFonts.inter(fontSize: 16, color: Color(0xFF757575)),
      ),
